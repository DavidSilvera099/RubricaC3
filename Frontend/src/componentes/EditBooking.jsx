...
export const EditBooking = ({idbookings ,codigo_habitacion, telefono_cliente, fecha_entrada, fecha_salida, setopenEdit}) => {
  ...
  return (
    ...
    <div >
        ...
        <input type="number" {...register('codigo_habitacion', {required:true})}/>
    </div>
    <div >
        <label htmlFor="" >Telefono cliente:</label>
        <input type="number" {...register('telefono_cliente', {required:true})} />
    </div>
    <div >
